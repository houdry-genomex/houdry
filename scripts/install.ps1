...
Write-Host ""
Write-Host "Check the version (should be current release, not Phase-1-only):"
Write-Host "  houdry version"
Write-Host ""
Write-Host "Detect this GPU, then register it as compute (leave that running):"
Write-Host "  houdry gpu detect"
Write-Host "  houdry gpu register"
Write-Host ""
